...
class Notification(models.Model):
    ...
    from_user = models.ForeignKey('authentication.Profile', related_name='n_from', on_delete=models.PROTECT)
    to_user = models.ForeignKey('authentication.Profile', related_name='n_to', on_delete=models.PROTECT)
    date = models.DateTimeField(auto_now_add=True)
    order = models.ForeignKey(Order, null=True, blank=True, on_delete=models.PROTECT)
    medicine = models.ForeignKey('useradmin.Medicine', null=True, blank=True, on_delete=models.PROTECT)
    stock = models.ForeignKey('usershop.ShopStock', null=True, blank=True, on_delete=models.PROTECT)
